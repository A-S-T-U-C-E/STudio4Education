...
parcelRequire = (function(modules, cache, entry, globalName) {
        ...
        }, { "../cpu/interrupt": "../../src/cpu/interrupt.ts", "./gpio": "../../src/peripherals/gpio.ts" }],
        "../../src/peripherals/usart.ts": [function(require, module, exports) {
            "use strict";
        ...
        }, { "../cpu/interrupt": "../../src/cpu/interrupt.ts" }],
        ...
        }, { "./cpu/cpu": "../../src/cpu/cpu.ts", "./cpu/instruction": "../../src/cpu/instruction.ts", "./cpu/interrupt": "../../src/cpu/interrupt.ts", "./peripherals/timer": "../../src/peripherals/timer.ts", "./peripherals/gpio": "../../src/peripherals/gpio.ts", "./peripherals/usart": "../../src/peripherals/usart.ts", "./peripherals/eeprom": "../../src/peripherals/eeprom.ts", "./peripherals/twi": "../../src/peripherals/twi.ts" }],
        ...
        }, { "avr8js": "../../src/index.ts", "./intelhex": "intelhex.ts", "./task-scheduler": "task-scheduler.ts" }],
        "format-time.ts": [function(require, module, exports) {
            "use strict";
    ...
    digitalWrite(13, LOW);
            ...
            function executeProgram(hex) {
                ...
                globalThis.AVR8jsFalstad.Runner.usart.onByteTransmit = value => {
                    ...
                    console.log(serialOutputText.textContent);
                };
            ...
            async function compileAndRun() {
                ...
                try {
                    ...
                    console.log(compilerOutputText.textContent);
        ...
        }, { "./compile": "compile.ts", "./cpu-performance": "cpu-performance.ts", "./execute": "execute.ts", "./format-time": "format-time.ts", "./index.css": "index.css", "./utils/editor-history.util": "utils/editor-history.util.ts" }],
