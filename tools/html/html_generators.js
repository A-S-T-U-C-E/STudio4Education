...
HtmlGenerator['title'] = function(block) {
  ...
  let code = '<title>' + statements_content.trim() + '</title>\n';
  return code;
};
...
HtmlGenerator['genericstyle'] = function(block) {
  ...
  let code = text_property + ': ' + text_value + ';';
  return code;
};
...
HtmlGenerator['more_attributes'] = function(block) {
  ...
  let code = value_name1 + value_name2 + value_name3;
  return [code, HtmlGenerator.ORDER_NONE];
};
...
HtmlGenerator['genericattribute'] = function(block) {
  ...
  var text_value = block.getFieldValue('value');
  let code = ' ' + text_attribute + '="' + text_value + '"';
  return [code, HtmlGenerator.ORDER_NONE];
};
...
HtmlGenerator['link'] = function(block) {
  var text_name = block.getFieldValue('NAME');
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  let code = '<a href="' + text_name + '">' + statements_content.trim() + '</a>\n';
  return code;
};
...
HtmlGenerator['span'] = function(block) {
  var value_name = HtmlGenerator.valueToCode(block, 'NAME', HtmlGenerator.ORDER_ATOMIC);
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  let code = '<span' + value_name + '>' + statements_content.trim() + '</span>\n';
  return code;
};
...
HtmlGenerator['image'] = function(block) {
  ...
  let code = '<img src="' +  text_image + '" alt="' + text_alt + '">\n';
  return code;
};

HtmlGenerator['emphasise'] = function(block) {
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  let code = '<em>' + statements_content.trim() + '</em>\n';
  return code;
};

HtmlGenerator['strong'] = function(block) {
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  let code = '<strong>' + statements_content.trim() + '</strong>\n';
  return code;
};
...
HtmlGenerator['headline'] = function(block) {
  ...
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  let code = '<' + dropdown_name + '>' + statements_content.trim() + '</' +  dropdown_name + '>\n';
  return code;
};
...
HtmlGenerator['listelement'] = function(block) {
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  let code = '<li>' + statements_content + '</li>\n';
  return code;
};

HtmlGenerator['inserted'] = function(block) {
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  let code = '<ins>' + statements_content.trim() + '</ins>\n';
  return code;
};

HtmlGenerator['deleted'] = function(block) {
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  let code = '<del>' + statements_content.trim() + '</del>\n';
  return code;
};

HtmlGenerator['super'] = function(block) {
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  let code = '<sup>' + statements_content.trim() + '</sup>\n';
  return code;
};

HtmlGenerator['sub'] = function(block) {
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  let code = '<sub>' + statements_content.trim() + '</sub>\n';
  return code;
};
...
HtmlGenerator['quote'] = function(block) {
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  let code = '<q>' + statements_content.trim() + '</q>\n';
  return code;
};
...
HtmlGenerator['variable'] = function(block) {
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  let code = '<var>' + statements_content.trim() + '</var>\n';
  return code;
};
...
HtmlGenerator['input'] = function(block) {
  ...
  let code = '<input type="' + dropdown_type + '" value="' + text_value + '"' + value_text + ' />\n';
  return code;
};
...
HtmlGenerator['onclick'] = function(block) {
  ...
  let code = ' onclick="' + statements_name.trim() + '"';
  return [code, HtmlGenerator.ORDER_NONE];
};
