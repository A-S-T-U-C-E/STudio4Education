    ...
    const pickPlaceEnabled = {
        displayText: function() {
            if (Blockly.myPickPlaceBlock.enabled)
                return MSG["PICKPLACEBLOCK_PICKPLACE_DISABLED"];
            else
                return MSG["PICKPLACEBLOCK_PICKPLACE_ENABLED"];
        },
...
//     Blockly.utils.KeyCodes.W, [Blockly.ShortcutRegistry.modifierKeys.Shift]);
// Blockly.ShortcutRegistry.registry.register(registerPickPlaceEnabled);
// Blockly.ShortcutRegistry.registry.addKeyMapping(shiftW, 'moveToStack');
...
function registerClickToPick() {
    ...
    const clickToPick = {
        displayText: function() {
            return MSG["PICKPLACEBLOCK_CLICK_TO_PICK"];
        },
        preconditionFn: function(a) {
            if (Blockly.myPickPlaceBlock.enabled)
                return 'enabled';
...
registerClickToPick();
// var shiftX = Blockly.ShortcutRegistry.registry.createSerializedKey(
//     Blockly.utils.KeyCodes.X, [Blockly.ShortcutRegistry.modifierKeys.Shift]);
// Blockly.ShortcutRegistry.registry.register(registerClickToPick);
// Blockly.ShortcutRegistry.registry.addKeyMapping(shiftX, 'registerClickToPick');
...
function registerClickToPlace_next() {
    ...
    const clickToPlace_next = {
        displayText: function() {
            return MSG["PICKPLACEBLOCK_CLICK_TO_PLACE_NEXT"];
        },
        preconditionFn: function(a) {
...
// var shiftN = Blockly.ShortcutRegistry.registry.createSerializedKey(
//     Blockly.utils.KeyCodes.N, [Blockly.ShortcutRegistry.modifierKeys.Shift]);
// Blockly.ShortcutRegistry.registry.register(registerClickToPlace_next);
// Blockly.ShortcutRegistry.registry.addKeyMapping(shiftN, 'registerClickToPlace_next');
...
function registerClickToPlace_previous() {
    ...
    const clickToPlace_previous = {
        displayText: function() {
            return MSG["PICKPLACEBLOCK_CLICK_TO_PLACE_PREVIOUS"];
        },
        preconditionFn: function(a) {
...
// var shiftP = Blockly.ShortcutRegistry.registry.createSerializedKey(
//     Blockly.utils.KeyCodes.P, [Blockly.ShortcutRegistry.modifierKeys.Shift]);
// Blockly.ShortcutRegistry.registry.register(registerClickToPlace_previous);
// Blockly.ShortcutRegistry.registry.addKeyMapping(shiftP, 'registerClickToPlace_previous');
...
function registerClickToPlace_output(index) {
    ...
    const clickToPlace_input = {
        displayText: function() {
            return MSG["PICKPLACEBLOCK_CLICK_TO_PLACE_INPUT"].replace("#", Blockly.Msg["MYPICKPLACEBLOCK_CLICK_TO_PLACE_INPUT_NAME"][index]);
        },
        preconditionFn: function(a) {
...
// var shiftV = Blockly.ShortcutRegistry.registry.createSerializedKey(
//     Blockly.utils.KeyCodes.V, [Blockly.ShortcutRegistry.modifierKeys.Shift]);
// Blockly.ShortcutRegistry.registry.register(registerClickToPlace_output);
// Blockly.ShortcutRegistry.registry.addKeyMapping(shiftV, 'registerClickToPlace_output');
