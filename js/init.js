...
Code.injectLanguageStrings = function() {
    ...
    document.getElementById('importPapyrusButton').title = MSG['importPapyrusButton_span'];
    document.getElementById('importSysMLButton').title = MSG['importSysMLButton_span'];
    ...
    document.getElementById('importPapyrusButton_span_menu').textContent = MSG['importPapyrusButton_span'];
    document.getElementById('importSysMLButton_span_menu').textContent = MSG['importSysMLButton_span'];
    ...
    document.getElementById('drawioButton_span_menu').textContent = MSG['drawio_span'];
    document.getElementById('launchNodeRed_span_menu').textContent = MSG['launchNodeRed_span'];
    document.getElementById('launchNodeRedServer_span_menu').textContent = MSG['launchNodeRedServer_span'];
    ...
    document.getElementById('papyrusConfiguration_AHF_id_span').textContent = MSG['papyrusConfiguration_AHF_id_span'];
    document.getElementById('papyrusConfiguration_AHF_name_span').textContent = MSG['papyrusConfiguration_AHF_name_span'];
    document.getElementById('papyrusConfiguration_AHF_save_span').textContent = MSG['papyrusConfiguration_AHF_save_span'];
