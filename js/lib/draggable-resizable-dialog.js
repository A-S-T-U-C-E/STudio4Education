...
function DialogBox(id, callback) {
    ...
    _onMouseUp = function(evt) {
        ...
        _whichClick = function(btn) {
            // comment to avoid automatic close of modal on any click
        ...
        _init = function(id, callback) {
            ...
            _minW = Math.max(_dialog.clientWidth, _minW, +(_buttons.length > 1 ?
            ...
            _minH = Math.max(_dialog.clientHeight, _minH, +parseInt(_dialogContentStyle.top) // .dialog .content { top: 48px } 
                +
