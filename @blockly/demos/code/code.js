...
Code.changeLevel = async function() {
    ...
    switch (levelMenuSelection) {
        case 'skill1':
            ...
            document.getElementById("importPapyrusButton").style.display = 'none';
            document.getElementById("importSysMLButton").style.display = 'none';
        ...
        case 'skill2':
            ...
            document.getElementById("functionsIcons").prepend(document.getElementById("importPapyrusButton"));
            document.getElementById("functionsIcons").prepend(document.getElementById("importPapyrusButton_span_menu"));
            document.getElementById("functionsIcons").prepend(document.getElementById("importSysMLButton"));
            document.getElementById("functionsIcons").prepend(document.getElementById("importSysMLButton_span_menu"));
            document.getElementById("functionsIcons").prepend(document.getElementById("resetButton"));
            ...
            document.getElementById("buttonsMenuPopupInside").appendChild(document.getElementById("importPapyrusButton"));
            document.getElementById("buttonsMenuPopupInside").appendChild(document.getElementById("importPapyrusButton_span_menu"));
            document.getElementById("buttonsMenuPopupInside").innerHTML += '<br>';
            document.getElementById("buttonsMenuPopupInside").appendChild(document.getElementById("importSysMLButton"));
            document.getElementById("buttonsMenuPopupInside").appendChild(document.getElementById("importSysMLButton_span_menu"));
            document.getElementById("buttonsMenuPopupInside").innerHTML += '<br>';
            document.getElementById("buttonsMenuPopupInside").innerHTML += '<hr>';
            ...
            document.getElementById("importPapyrusButton").style.display = 'inline';
            document.getElementById("importSysMLButton").style.display = 'inline';
