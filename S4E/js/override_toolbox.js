...
class TweakCategories extends Blockly.ToolboxCategory {
    ...
    setSelected(isSelected) {
        ...
        if (isSelected) {
            ...
            const rgb = hexToRgb(this.colour_);
            const color = new Color(rgb[0], rgb[1], rgb[2]);
            const solver = new Solver(color);
            const result = solver.solve();
            this.iconDom_.style = result.filter;
        } else {
            this.rowDiv_.style.backgroundColor = this.colour_;
            labelDom.style.color = 'white';
            this.iconDom_.style.filter = 'invert(1)';
        }
    ...
    createIconDom_() {
        ...
        iconImg.setAttribute("data", "./media/toolbox/" + this.toolboxItemDef_['toolboxitemid'] + ".svg");
        iconImg.setAttribute("class", "customIcon");
        return iconImg;
    }
}
